...
from metric.ngrams import SpanProcessor, span_frequency
from metric.tree import Tree, num_nodes, compression
#from constants import EMP_HOME

OUTPUTS_HOME = os.path.join("", "data/")
...
def _load_data_default(responses_filepath):
    """
    Load responses.
    """
    with open(responses_filepath, "r") as file_p:
...
def gather_stats(responses, ngrams_dir):
    ...
    #responses = _load_data_default(responses_filepath)
