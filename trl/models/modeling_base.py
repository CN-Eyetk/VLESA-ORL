...
from src.transformers import PreTrainedModel
...
def create_reference_model(
    model: PreTrainedModelWrapper, num_shared_layers: int = None, pattern: str = None, name_unshared_layers: List[str] = None
    ...
    unshared_param_list = []
    if name_unshared_layers is not None:
        for name, param in model.named_parameters():
            if name not in name_unshared_layers:
        ...
        for name, param in model.named_parameters():
            ...
            if shared_parameter:
                ...
                unshared_param_list.append(name)
        #print("shared_param_list",shared_param_list)
        #print("unshared_param_list",unshared_param_list)
        # create reference of the original parameter if they are shared
    print("unshared_param_list (active parameter in model)=  ", unshared_param_list)
