...
comm="python3 main.py --no_fuse --use_kl --tag pm608/bleu2 --emo_out_loss_ratio 0.05 --use_vae --mixed_vae --strategy_loss_ratio 0.2 --log_on_wandb --data_path origin_data"
