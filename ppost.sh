...
cur_comm+=" --ppo_init_kl_coef "$ppo_init_kl_coef
cur_comm+=" --ppo_lm_loss "$lm_loss
cur_comm+=" --ppo_lr "$lr
echo $cur_comm
...
pretrained_model="/disk/junlin/EmoSp/bart-our/-LIGHT-TRANS4PPO/all_loss-1.0_0.05_0.05_510-spst-Emoin-w_eosstg-w_emocat-w_stgcat-vae-mvae32-vad--1.0-ct0.5-lcpm328/bleu2/epoch0_step${step}_2024-04-05/lr_${lr}-bs_${batch_size}-sl_0-gs_${gradient_accumulation_steps}-kl_${ppo_init_kl_coef}-wr_0-sr_0.5-lm_${$lm_loss}_stem_1wo_fullwo_diff_nonmixtemp"
