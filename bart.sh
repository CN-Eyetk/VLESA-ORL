...
use_cat=( "")
use_bart=(" ")
lrs=(5e-5 2e-5 3e-5 1e-5)
use_role=(" --use_role_embed")
use_situ=("")
rl_rat=(0.2 0.4 0.6 0.8 0.0 )
emo_loss_rat=(0.2)
...
comm="python3 main.py --no_fuse  --use_bart --use_kl --tag 124_II --emo_out_loss_ratio 0.2 --use_vae --use_emo_in --emo_use_cat_attn --stg_use_cat_attn --wo_comet"
